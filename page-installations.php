...
<div class="content page-events">
  ...
  <h1>Events - <?php if (is_category()) { single_cat_title(); } else { single_post_title(); } ?></h1>
	...
	<?php
      ...
      $installationsQuery = new WP_Query( array( 'category_name' => 'installations+upcoming events' ) );
      if($installationsQuery->have_posts()) : while($installationsQuery->have_posts()) : $installationsQuery->the_post();
    ?>
    ...
    <?php endwhile; else : ?>
  	  <p>No installations are scheduled at this time.</p> 
    <?php endif; // end the loop ?>
  
    <!--<small>page-installations.php</small>-->
